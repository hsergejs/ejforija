...
<meta name="keywords" content=" Bliss Extra (2 Pills) " />
<meta name="description" content=" Bliss Extra (2 Pills)  " />

<title>Bliss Extra (2 Pills)</title>
...
<? include "block/menuright.php"; ?>
  ...
  <tr>
    <td align="center" valign="middle" width="50%"><p><strong>Bliss Extra (2 Pills)</strong></p></td>
    <td align="center" valign="middle" width="50%">&nbsp;</td>
  </tr>
  <tr>
    <td align="center" valign="middle"><img src="img/products/Herbal High Co/Bliss-Extra-(2-Pills).jpg" width="300" height="300" alt="Bliss Extra (2 Pills)" /></td>
    <td align="left" valign="top"><p>Bliss Extra's clever formula reduces the physical burnout that can be caused by stimulants and over-exertion, and as a result there is little or no comedown. Bliss Extra, like most stimulants, makes most people more inclined to drink lots of beer, use lots of fags, stay up late, and not eat food. </p>
      <p>This can make you feel a bit rough, so remember not to go to crazy unless you want to.</p></td>
  </tr>
</table>
</td>
      </tr>
