...
<? include "block/menuright.php"; ?>
  ...
  <tr>
    <td align="center" valign="middle" width="50%"><p><strong>Kratom Extract</strong></p></td>
  ...
  <tr>
    ...
    <td align="left" valign="middle"><p>Kratom Standardized Extract often used as a substitute for opium when opium is unavailable, or to moderate opium addiction. In folk medicine, it is often used to tread diarrhoea. A small minority of users use Kratom to prolong sexual intercourse. </p>
      <p><strong>Use:</strong><br /> 
        tea, smoking and chewing (most effective).</p>
