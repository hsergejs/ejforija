...
<? include "block/menuright.php"; ?>
  ...
  <tr>
    <td align="center" valign="middle" width="50%"><p><strong>Maeng Da Kratom Leaf </strong></p></td>
  ...
  <tr>
    ...
    <td align="left" valign="middle"><p>Maeng Da Kratom (Pimp's Kratom), Mitragyna speciosa. This genetically grown Thai Kratom called Maeng Da Kratom which roughly translated to English means "Pimp's Kratom" has been hand selected from Thailand for its very strong effects. Active at only 1 to 2 grams, Maeng Da Kratom has a distinct smell.</p>
