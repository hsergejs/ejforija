...
<? include "../rus/block/menuright.php"; ?>
  ...
  <tr>
    <td align="center" valign="middle" width="50%"><p><strong>Vegas Nights (3 Капсулы)</strong></p></td>
  ...
  <tr>
    ...
    <td align="left" valign="top"><p>Это последняя разработка не содержащих БЗП энергетических  стимуляторов, он увеличит вашу энергию во время вечеринок,  подарив незабываемые ощущения </p></td>
  </tr>
</table>
</td>
      </tr>
