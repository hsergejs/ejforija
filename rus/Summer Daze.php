...
<? include "../rus/block/menuright.php"; ?>
  ...
  <tr>
    ...
    <td align="left" valign="top"><p>Новое поколение &quot;Подкормок для  растений&quot; от London Underground.<br />
      Подкормка для растений Summer Daze основана на  новой формуле, идеальна подойдет для тропических растений.</p>
<br />
