...
<meta name="keywords" content=" Punk+ (2 Pills) " />
<meta name="description" content=" Punk+ (2 Pills)  " />

<title>Punk+ (2 Pills)</title>
...
<? include "../rus/block/menuright.php"; ?>
  ...
  <tr>
    <td align="center" valign="middle" width="50%"><p><strong>Punk+ (2 Пилюли)</strong></p></td>
    <td align="center" valign="middle" width="50%">&nbsp;</td>
  </tr>
  <tr>
    <td align="center" valign="middle"><img src="../img/products/Herbal High Co/Punk+-(2-Pills).jpg" width="300" height="300" alt="Punk+ (2 Pills)" /></td>
    <td align="left" valign="top"><p>Новое дополнение к травяному диапазону  максимумов, является сильным не содержащим БЗП стимулятором.<br />
Очень стимулирующий, помогает бороться с усталостью и держит вас в движением.</p></td>
  </tr>
</table>
</td>
      </tr>
