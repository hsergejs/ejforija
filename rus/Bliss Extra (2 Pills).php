...
<? include "../rus/block/menuright.php"; ?>
  ...
  <tr>
    <td align="center" valign="middle" width="50%"><p><strong>Bliss Extra (2 Пилюли)</strong></p></td>
  ...
  <tr>
    ...
    <td align="left" valign="top"><p><strong>Bliss Extra </strong>умная и эффективная формула, уменьшает физическое сгорание,  которое может быть вызвано стимуляторами или перенапряжением, в результате нету  никакого негативного эффекта. Этот продукт, как и большинство стимуляторов,  делает большинство людей более склонными выпить побольше пива, ложиться спать  поздно, и не есть пищу. </p></td>
  </tr>
</table>
</td>
      </tr>
