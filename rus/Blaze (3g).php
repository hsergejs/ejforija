...
<? include "../rus/block/menuright.php"; ?>
  ...
  <tr>
    <td align="center" valign="middle" width="50%"><p><strong>Blaze (3г)</strong></p></td>
  ...
  <tr>
    ...
    <td align="left" valign="top"><p>Интригующая новинка от голландских производителей. Blaze  обладает глубоким, насыщенным запахом и густым дымом. Blaze замечательно  релаксирует, расслабляет и поднимает позитивное настроение.</p><br />

<p>Blaze (3г) - &#8364;25</p>

<p> <strong>Также достуно Blaze joints:</strong><br />

Blaze joint - &#8364;10 за 3 jointа<br />
Blaze joint - &#8364;4 за 1 joint 
