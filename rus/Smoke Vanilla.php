...
<meta name="keywords" content=" Smoke Vanilla " />
<meta name="description" content=" Smoke Vanilla  " />

<title>Smoke Vanilla</title>
...
<? include "../rus/block/menuright.php"; ?>
  ...
  <tr>
    <td align="center" valign="middle" width="50%"><p><strong>Smoke Vanilla (3г)</strong></p></td>
    <td align="center" valign="middle" width="50%">&nbsp;</td>
  </tr>
  <tr>
    <td align="center" valign="middle"><img src="../img/products/smoke/Smoke-Vanilla-(3g).jpg" width="300" height="300" alt="Smoke Vanilla" /></td>
    <td align="left" valign="top"><p><strong>Smoke</strong><strong> </strong><strong>Vanilla</strong>&nbsp;- новинка от компании Organic Worx. Один из самых мощных ароматических  миксов не сегодняшний день теперь и с ароматом ванили! В его состав входят  только тщательно отобранные компоненты, придающие ему знаменитую силу аромата.&nbsp;<br />
      <strong>Smoke Vanilla</strong>&nbsp;- это то, что стоит  попробовать всем поклонникам бестселлера Smoke. Этот микс не разочарует  поклонников сильных ароматов.&nbsp;<br />
    </p>
      <p><strong>Состав:</strong> Erythrina, Aesculus, Cinnamomum  и Verbascum genuses и др.</p></td>
  </tr>
</table>
</td>
      </tr>
