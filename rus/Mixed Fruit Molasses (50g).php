...
<? include "../rus/block/menuright.php"; ?>
  ...
  <tr>
    <td align="center" valign="middle" width="50%"><p><strong>Фруктовая патока (50g)</strong></p></td>
  ...
  <tr>
    ...
    <td align="left" valign="top"><p><strong>Без смол, без никотина, без табака.</strong></p>
      <p><br />
        Листья табака заменены на сахарную свеклу, поэтому патока  горит так же как и лист табака, но без табака </p></td>
  </tr>
</table>
</td>
      </tr>
